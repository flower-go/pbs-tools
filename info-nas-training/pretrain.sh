...
codedir="$DATADIR"/odPremka/PPO/overcooked_pytorch_stable_baselines/overcooked_ai/src/overcooked_ai_py/diverse_population
...
python "$codedir"/diverse_pool_build.py > "$SCRATCHDIR"/out.txt 2> "$SCRATCHDIR"/err.txt
